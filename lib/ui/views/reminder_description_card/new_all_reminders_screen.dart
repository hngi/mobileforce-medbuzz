    ...
    return DefaultTabController(
      ...
      child: Scaffold(
          ...
          body: TabBarView(children: [
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(children: <Widget>[
                      ...
                      Container(
                        height: height * 0.6,
                        //lists all the notifications for the week
                        child: ListView.builder(
                            itemCount: notificationDB
                                .currentWeeklyNotifications.length,
                            itemBuilder: (BuildContext context, index) =>
                                Container(
                                  ...
                                  model: notificationDB
                                      .currentWeeklyNotifications[index],
                                ))),
                      )
                    ]),
                  ),
            ...
            Text('This is the part for badges')
          ])),
    );
  }
}
