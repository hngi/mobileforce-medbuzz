...
class _MedicationScreenState extends State<MedicationScreen> {
  ...
  void initState() {
    ...
    controller.addListener(() {
      if (controller.offset < 120) {
        Provider.of<MedicationScheduleModel>(context).updateVisibility(true);
      } else {
        Provider.of<MedicationScheduleModel>(context).updateVisibility(false);
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    var model = Provider.of<MedicationScheduleModel>(context);
...
class CustomDateButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var model = Provider.of<MedicationScheduleModel>(context, listen: false);
    return Container(
